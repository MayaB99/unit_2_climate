...
for (value in c("My", "second", "for", "loop")) {
  print(value)
  my_filenames = data.frame(file =c("a.csv", "b.csv""))
  for (i in length(my_filenmaes)){read.csv(my_filenames$file[i])}
}
...
for (i in seq(from=1, to=n)){ my_squared_vector[i] = my_vector[i]^2}
```
